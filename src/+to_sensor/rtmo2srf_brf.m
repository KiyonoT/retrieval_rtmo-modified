function [refl_band, soil_band, fluo] = rtmo2srf_brf(rad, SIF, soil_refl, wlP, irr_prospect, sensor)
    rso     = rad.rso;
    ...
    [~, ~, E_int] = equations.transmittances2irradiance(irr_prospect, rdd, rsd, sensor.Rin);

    refl_band = cut_to_srfs(rso + SIFs./E_int, wlP, sensor);
